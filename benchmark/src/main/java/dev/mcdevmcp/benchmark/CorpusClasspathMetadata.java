...
public record CorpusClasspathMetadata(String globalManifestPath, String globalManifestSha256, String versionManifestPath, URI versionManifestUrl, String versionManifestSha1) {
    public CorpusClasspathMetadata {
        ...
        if (!"https".equals(versionManifestUrl.getScheme()) || versionManifestUrl.getHost() == null || versionManifestUrl.getUserInfo() != null || versionManifestUrl.getFragment() != null) throw new IllegalArgumentException("Metadata URL must use absolute HTTPS");
