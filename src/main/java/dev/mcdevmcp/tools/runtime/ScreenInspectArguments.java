...
value record ScreenInspectArguments(@InputProperty(description = "Render each unique item's icon and attach as an icons map. Default false.", defaultValue = "false") boolean includeIcons) {
