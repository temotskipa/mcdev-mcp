...
final class McNearbyEntitiesTool {
    ...
    static ToolBinding<NearbyEntitiesArguments> binding(RuntimeToolSupport support) {
        ...
        return ToolBinding.compatibility(decoder, (arguments, _) -> support.container(ENDPOINT, RuntimeToolSupport.payload("range", arguments.range(), "limit", arguments.limit(), "includeIcons", arguments.includeIcons())));
    }
}
