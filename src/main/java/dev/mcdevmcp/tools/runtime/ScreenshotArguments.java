...
value record ScreenshotArguments(@InputProperty(description = "Integer downscale factor. 1 = full window resolution. 2 = half each axis (default).", minimum = "1", defaultValue = "2") int downscale, @InputProperty(description = "JPEG quality in [0.05, 1.0]. Default: 0.75.", minimum = "0.05", maximum = "1", defaultValue = "0.75") double quality) {
