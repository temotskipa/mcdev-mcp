...
public final class SymbolSchema {
    ...
    private static final Map<String, String> CHECK_CLAUSES = Map.of("CK_METADATA_SINGLETON", "SINGLETON", "CK_PACKAGES_SOURCE_IDENTITY", "SOURCE_NAMESPACE='MINECRAFT'ANDFABRIC_API_VERSIONISNULLORSOURCE_NAMESPACE='FABRIC'ANDFABRIC_API_VERSIONISNOTNULL", "CK_TYPES_SOURCE_IDENTITY", "SOURCE_NAMESPACE='MINECRAFT'ANDFABRIC_API_VERSIONISNULLORSOURCE_NAMESPACE='FABRIC'ANDFABRIC_API_VERSIONISNOTNULL", "CK_TYPES_KIND", "KINDIN'CLASS','INTERFACE','ENUM','RECORD','ANNOTATION'");
