...
public final class SymbolSchema {
    ...
    public static void create(
            ...
            Path sourceRoot,
            String remappedJarSha256,
            Instant builtAt) throws SQLException {
    ...
    private static void insertMetadata(java.sql.PreparedStatement statement, String key, String value)
            throws SQLException {
