...
public record SourcePreparationStamp(int schemaVersion, SourceOwnership ownership, SourceProducerIdentity producer,
                                     SourceInputIdentity inputs, SourceTreeInventory inventory, SourceValidation validation) {
    public SourcePreparationStamp {
        ...
        if ((ownership == SourceOwnership.GENERATED) != (producer != null)) {
