...
public final class SourceIndexer {
    public IndexSummary build(IndexRequest request) throws IndexBuildException {
        ...
        try {
            ...
            ParsedIndex parsed = new JavacSourceParser().parse(request, catalog, classpath, corpus);
            ...
            IndexCounts counts = new SymbolIndexWriter().write(request, parsed, remappedJarSha256, Instant.now());
