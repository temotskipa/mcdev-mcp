...
class H2StorageContractTest {
    ...
    void treatsDarwinAsMacAndBlankEnvironmentRootsAsFallbacks() {
        ...
        assertEquals(
                ...
                PlatformPaths.forEnvironment("Darwin", Map.of(), home).cacheRoot());
        assertEquals(
                Path.of("/Users/alex/AppData/Local/mcdev-mcp/Cache"),
                PlatformPaths.forEnvironment("Windows", Map.of("LOCALAPPDATA", "   "), home).cacheRoot());
        assertEquals(
                Path.of("/Users/alex/.cache/mcdev-mcp"),
                PlatformPaths.forEnvironment("Linux", Map.of("XDG_CACHE_HOME", ""), home).cacheRoot());
    }
}
